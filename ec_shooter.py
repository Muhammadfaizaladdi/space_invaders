   ...
   for e in event.get():
       ...
       #event of pressing the spacebar - the sprite shoots
           ...
           if e.key == K_SPACE:
               ...
               if ammo >= 0 and reload_time == False:
                   fire_sound.play()
                   ship.fire()
                   ammo -= 1
               if ammo < 0 and reload_time == False:
 ...
 #the game itself: actions of sprites, checking the rules of the game, redrawing
   if not finish:
       ...
       if reload_time:
           ...
           if end_reload - start_reload < 2:
               text_reload = font2.render("On Reload", 1, (250, 0, 0))
               window.blit(text_reload, (250, 460))
           else:
               ammo = 5
               reload_time = False
       ...
       text_life = font1.render(str(life), 1, (0, 250, 0))
